...
function theme.set_highlights(options)
	...
	hl(0, "Search", { fg = palette.search_fg , bg = palette.search_bg })
	hl(0, "CurSearch", { fg = palette.cur_search_fg , bg = palette.cur_search_bg })
	hl(0, "IncSearch", { fg = palette.inc_search_fg , bg = palette.inc_search_bg })
	...
	hl(0, "PreProc", { fg = palette.magenta, bg = "NONE" })
	...
	hl(0, "@nowl.visual.active", { fg = palette.visual_fg, bg = palette.visual_bg })
	hl(0, "@nowl.visual.inactive", { fg = "RED", bg = palette.dark_purple })
	...
	hl(0, "@string.json", { fg = palette.magenta, bg = "NONE" })
